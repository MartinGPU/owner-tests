package com.marat.test.pages;

import com.codeborne.selenide.Condition;
import com.codeborne.selenide.SelenideElement;

import static com.codeborne.selenide.Selenide.*;
import static com.marat.test.tests.TestData.cityHotel;
...
public class BookingAHotelPage {
    ...
    private final SelenideElement
            ...
            dayBegins = $("[aria-label='Thu Jun 01 2023']"), // $("[data-ti-date='2023-04-01T08:00:00.000Z']"),
            dayEnds = $("[aria-label='Fri Jun 02 2023']"), // $("[data-ti-date='2023-04-30T08:00:00.000Z']"),
            ...
            quickSetDate = $$("._2LrW8HTzFnQk7kETnQ9pGU").get(3),
...
//        });
    ...
    public void checkResults() {
        step("Check availability", () -> {
            ...
            dateAndGuestsCheck.shouldHave(Condition.text("1 июн - 2 июн • 5 гостей"));
